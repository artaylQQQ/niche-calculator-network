...
export const schema = {
  ...
  "info": [
    "The arc length formula multiplies radius by angle in radians; degrees are converted for convenience.",
    "Common in engineering and design when specifying curved segments or partial circumferences.",
    "An angle of 360° yields the full circumference, equal to 2π times the radius."
  ],
  "faqs": [
    {
