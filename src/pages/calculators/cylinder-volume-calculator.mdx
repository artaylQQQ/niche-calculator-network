...
"slug": "cylinder-volume-calculator","title": "Cylinder Volume Calculator","locale": "en","inputs": [{"name": "radius","type": "number","min": 0,"step": 0.001,"hint": "Radius"},],"expression": "3.141592653589793 * radius^2 * height","formula_js": "","units": ,"intro": "Volume of a cylinder.","examples": [],"faqs": [],"disclaimer": "Educational information, not professional advice.","schema_org": "FAQPage|SoftwareApplication","cluster": "Geometry & Math"}
