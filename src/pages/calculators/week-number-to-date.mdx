...
export const schema = {
  ...
  "inputs": [
    ...
    {"name":"week","label":"ISO Week","type":"number","step":1,"placeholder":"10"}
  ],
  ...
  "faqs": [
    {"question":"What is ISO week 1?","answer":"The week containing January 4th."},
    {"question":"Are results in ISO format?","answer":"Yes, YYYY-MM-DD."}
  ],
