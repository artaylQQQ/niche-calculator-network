...
"slug": "circle-area-calculator","title": "Circle Area Calculator","locale": "en","inputs": [{"name": "radius","type": "number","min": 0,"step": 0.001,"hint": "Radius"}],"expression": "3.141592653589793 * radius^2","formula_js": "","units": ,"intro": "Area of a circle.","examples": [],"faqs": [],"disclaimer": "Educational information, not professional advice.","schema_org": "FAQPage|SoftwareApplication","cluster": "Geometry & Math"}
