...
export const schema = {
  ...
  "info": [
    "Business days normally exclude Saturdays and Sundays; some regions also omit local holidays.",
    "Maintaining a holiday calendar provides more accurate scheduling for project deadlines.",
    "Useful for calculating invoice due dates, shipping estimates, or service-level agreements."
  ],
  "faqs": [
    {
      "question": "Are weekends skipped?",
      "answer": "Yes, Saturdays and Sundays are excluded."
    },
    {
