...
export const schema = {
  ...
  "inputs": [
    ...
    {"name":"r","label":"r","type":"number","step":1,"placeholder":"2"}
  ],
  ...
  "faqs": [
    {"question":"What does n choose r mean?","answer":"The number of ways to pick r items from n without order."},
    {"question":"Can r exceed n?","answer":"No, result is zero if r > n."}
  ],
