...
export const schema = {
  ...
  "faqs": [
    {
      "question": "Why equate weight loss to liters?",
      "answer": "1 kg of weight change roughly equals 1 liter of water."
    },
    {
      "question": "Does it include sweat absorbed by clothes?",
