...
export const schema = {
  ...
  "intro": "Estimate how many cubic yards of mulch are needed based on coverage area and desired depth. Input the area in square feet and depth in inches to plan your order.",
  "examples": [
  ...
  "faqs": [
    ...
    { "question": "How do I convert to cubic feet?", "answer": "Multiply the result by 27 to get cubic feet." }
  ],
